  ...
  return (
    <section className="py-16 bg-background" id="novo-olhar">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 max-w-3xl shadow-[var(--shadow-md)]">
          ...
          <p className="text-[0.93rem] text-ink-2 leading-[1.82] mb-4">
            ...
            <em className="text-teal not-italic">prática no formato exacto do exame</em>.
          </p>
          <p className="text-[0.93rem] text-ink-2 leading-[1.82]">
            Cada sessão parte do nível real do aluno. Não se salta etapas. Não se memoriza o que não se compreendeu. E o objectivo final é sempre o mesmo: a nota.
          </p>
        </div>
      </div>
    </section>
