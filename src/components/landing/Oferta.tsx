          ...
          <div className="bg-card border border-border rounded-[18px] overflow-hidden shadow-[var(--shadow-lg)]">
            ...
            <div className="p-7 md:p-8">
              ...
              <div className="mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  <ScrollReveal delay={0}>
                    <div className="bg-ink border border-ink rounded-xl p-5 flex flex-col gap-3 relative transition-all hover:-translate-y-1 hover:shadow-[0_16px_40px_oklch(0.2_0.02_240/0.35)] hover:scale-[1.015] h-full">
                  ...
                  <ScrollReveal delay={120}>
                    <div className="bg-card border border-border rounded-xl p-5 flex flex-col gap-3 transition-all hover:-translate-y-1 hover:shadow-[var(--shadow-lg)] hover:border-teal-muted hover:scale-[1.015] h-full">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {chips.map((chip) => (
                  <div key={chip} className="flex items-center gap-1.5 bg-paper-2 border border-border rounded-full px-3 py-1.5 text-[0.73rem] text-ink-2 transition-transform hover:scale-105">
