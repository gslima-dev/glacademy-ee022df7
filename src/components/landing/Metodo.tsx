export function Metodo() {
  const steps = [
    ...
    },
    {
      ...
      text: "Cada sessão inclui prática com exercícios no formato exacto do exame nacional e feedback directo nos erros — com explicação do porquê. Dominar o conteúdo não chega; é necessário responder como os critérios exigem.",
    ...
    <section className="py-16 bg-paper-2 border-y border-border" id="metodo">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {steps.map((s) => (
            <div key={s.num} className="bg-card border border-border rounded-xl p-5 border-t-[3px] border-t-teal">
              <div className="font-serif text-[1.7rem] font-bold text-teal leading-none mb-2">{s.num}</div>
