        ...
        <div className="grid md:grid-cols-3 gap-4">
          {steps.map((s, i) => (
            <ScrollReveal key={s.num} delay={i * 120}>
              <div className="group bg-card border border-border rounded-xl p-5 h-full border-t-[3px] border-t-teal transition-all hover:-translate-y-1 hover:shadow-[var(--shadow-lg)] hover:scale-[1.02]">
